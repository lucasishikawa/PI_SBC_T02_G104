!function() {
  ...
  try {
    var e = document.getElementsByTagName("html")[0],
      i = "data-uw-w-loader";
    if (e && e.hasAttribute(i))
      return;
    e.setAttribute(i, "")
  } catch (t) {}
  var n = "https://cdn.userway.org/widgetapp/",
    a = n + "2022-06-23/widget_app_base_1655994846657.js",
    o = n + "2022-06-23/widget_app_1655994846657.js";
  if (location.origin && location.origin.indexOf(".webaim.") > -1 || location.origin && location.origin.indexOf("acsbace") > -1)
    setTimeout(function() {
      t()
    }, 1e3);
  else {
    if (!new RegExp("(bot|crawler)", "i").test(navigator.userAgent)) {
      ...
      navigator.userAgent.match(/mobile/i) && r && ("false" === r.mobile || !1 === r.mobile) || (function() {
        try {
          UserWayWidgetApp = {},
          (Object.keys(localStorage).filter(function(t) {
            return 0 === t.indexOf("userway-s")
          }).length > 0 || /Edge\/|Trident\/|MSIE/.test(navigator.userAgent)) && (a = o, UserWayWidgetApp.lazyLoaded = !0)
        } catch (t) {}
      }(), function(t, e) {
